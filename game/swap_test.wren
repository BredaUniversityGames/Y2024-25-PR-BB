...
class Main {
    ...
    static Start(engine) {
        ...
        name.name = "Directional Light Scene 1"

        var dLight = __dEntity.AddDirectionalLightComponent()
        dLight.color = Vec3.new(0.0, 0.0, 5.0)
        ...
        __spheres = engine.LoadModel("assets/models/MetalRoughSpheres.glb")[0]
    ...
    static Shutdown(engine) {
        ...
        engine.GetECS().DestroyEntity(__spheres)
        //engine.GetECS().DestroyEntity(__playerController)
        //for (child in __spheres) {
