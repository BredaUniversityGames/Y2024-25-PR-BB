...
namespace util
{
    ...
    MaterialHandle CreateMaterial(const VulkanBrain& brain, const std::array<ImageHandle, 5>& textures, const MaterialHandle::MaterialInfo& info, vk::Sampler sampler, vk::DescriptorSetLayout materialLayout, std::shared_ptr<MaterialHandle> defaultMaterial = nullptr);
