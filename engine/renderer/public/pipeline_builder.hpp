...
public:
    ...
    static vk::DescriptorSetLayout CacheDescriptorSetLayout(const std::shared_ptr<VulkanContext>& context, const std::vector<vk::DescriptorSetLayoutBinding>& bindings, const std::vector<std::string_view>& names, const std::string name);
