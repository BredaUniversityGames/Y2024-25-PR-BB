...
{
public:
    SkydomePipeline(const std::shared_ptr<GraphicsContext>& context, ResourceHandle<GPUMesh> sphere, const CameraResource& camera, ResourceHandle<GPUImage> hdrTarget,
