    ...
    , _settings("settings.json")
{
    ...
    _tonemappingPass = std::make_unique<TonemappingPass>(_context, _settings.data.tonemapping, _hdrTarget, _bloomTarget, *_gBuffers, _tonemappingTarget, *_swapChain, *_bloomSettings);
