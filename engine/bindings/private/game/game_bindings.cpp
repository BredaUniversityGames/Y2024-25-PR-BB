...
glm::vec3 GetAimAssistDirection(GameModule&, ECSModule& ecs, PhysicsModule& physics, const glm::vec3& forward)
{
    return AimAssist::GetAimAssistDirection(ecs, physics, forward);
}
}
